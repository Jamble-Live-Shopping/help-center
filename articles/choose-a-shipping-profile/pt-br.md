...
- Seu endereço de envio configurado (veja [Configurar o Envio](../1-getting-started/4-configurar-envio.md))

## O que é um perfil de envio?

Um perfil de envio é uma **categoria de tamanho e peso** que você atribui a cada produto que lista. Ele diz à Jamble qual será o tamanho e peso do pacote, para que o sistema possa calcular o custo de frete para os compradores.

Você não define os preços de frete. Quando um comprador adquire seu produto, a Jamble calcula automaticamente o custo de frete com base em três coisas:

1. **O perfil de envio** que você selecionou (tamanho e peso do pacote)
